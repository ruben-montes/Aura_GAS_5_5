...
public:
	...
	*/
	...
	UPROPERTY(BlueprintReadOnly, Replicated, ReplicatedUsing = "OnRep_ArmorPenetration",
	...
	UPROPERTY(BlueprintReadOnly, Replicated, ReplicatedUsing = "OnRep_CriticalHitChance",
		Category = "Secondary Attributes")
	FGameplayAttributeData CriticalHitChance;
	ATTRIBUTE_ACCESSORS(UAuraAttributeSet, CriticalHitChance);

	UPROPERTY(BlueprintReadOnly, Replicated, ReplicatedUsing = "OnRep_CriticalHitDamage",
		Category = "Secondary Attributes")
	FGameplayAttributeData CriticalHitDamage;
	ATTRIBUTE_ACCESSORS(UAuraAttributeSet, CriticalHitDamage);

	UPROPERTY(BlueprintReadOnly, Replicated, ReplicatedUsing = "OnRep_CriticalHitResistance",
		Category = "Secondary Attributes")
	FGameplayAttributeData CriticalHitResistance;
	ATTRIBUTE_ACCESSORS(UAuraAttributeSet, CriticalHitResistance);

	UPROPERTY(BlueprintReadOnly, Replicated, ReplicatedUsing = "OnRep_HealthRegeneration",
		Category = "Secondary Attributes")
	FGameplayAttributeData HealthRegeneration;
	ATTRIBUTE_ACCESSORS(UAuraAttributeSet, HealthRegeneration);

	UPROPERTY(BlueprintReadOnly, Replicated, ReplicatedUsing = "OnRep_ManaRegeneration",
		Category = "Secondary Attributes")
